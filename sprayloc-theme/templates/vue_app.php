...
<div id="app">
  ...
  <div v-else>
      ...
      <div class="cards-container" >
          <sprayloc-card v-for="item in filtered" v-bind:data="item" v-bind:image="getImageThumbnail(item.image)" @show-details="showDetails" v-bind:folder="getFolderName(item.folder)" :key="item.id"></sprayloc-card>
      </div>
          ...
          methods : {
            setCategory : function(category_name, event){
              ...
              if(category_name === "all") {
                ...
                this.$router.push({path:"/", query : {category : category_name}})
          ...
          if( this.data_loaded){
              ...
              let filtered_equipments =  this.equipment.filter((value) => {
                ...
                for(let word of words){
                  ...
                  let found_index = this.sanitizeName(value.name).toLowerCase().search(this.sanitizeName(word).toLowerCase())
