...
<div id="app-inventaire" >
    ...
    <div class="cards-container" v-else>
        ...
        <sprayloc-pagination class="pagination-bottom" :numcards="filtered.length" :filtered="filtered" :maxitems="pagination_max" @page-change="onPageChange" @change-pagination-max="onChangePaginationMax"></sprayloc-pagination>
